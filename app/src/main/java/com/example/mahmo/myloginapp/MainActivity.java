...
package com.example.mahmo.myloginapp;
...
import com.example.mahmo.myloginapp.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void bulogin(View view) {
        ...
        new MyAsyncTaskresources().execute("http://mounirian.com/model/serves/json/json2.php?username="+txtusername.getText().toString()+"&password=" +txtpassword.getText().toString());
    }
